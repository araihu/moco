...
ALTER TABLE authorization_policies RENAME TO authorization_policies_secret_path;
...
FROM authorization_policies_secret_path;

DROP TABLE authorization_policies_secret_path;
